...
def worker(params,runParmsDic,return_dict):
    ...
    X_train = X_train.reshape((n_samples_train, params['seq'], 1, (int)(params['timeSteps'] / params['seq']), n_features))
    X_test = X_test.reshape((n_samples_test, params['seq'], 1, (int)(params['timeSteps'] / params['seq']), n_features))
    ...
    result_recorder.record_results("Conv_Lstm_Univar", params, runParmsDic['optimzation_func'], res, c1, c2)
    return
...
def Run(_runParmsDic):
    ...
    # ------- accuracy ------
    result_recorder.create_headers(header="Conv_Lstm_Univar_accuracy", parameters=None)
    ...
    result_recorder.record_best_results("Conv_Lstm_Univar", gp_result)
    print("Best Results: ", gp_result)

    # ------- ks ------
    result_recorder.create_headers(header="Conv_Lstm_Univar-ks", parameters=None)
