...
def worker(params,runParmsDic,return_dict):
    ...
    X, y = sf.BuildDataSetForTimeSeries_Univariate(ds=ds, steps=params['timeSteps'], varName=varName, bNormalize=bNormalize)
    y = to_categorical(y)
    ...
    result_recorder.record_results("BLSTM_UNIVAR", params, runParmsDic['optimzation_func'], res, c1, c2)
    return
