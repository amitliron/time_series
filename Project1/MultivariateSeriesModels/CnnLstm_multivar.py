...
from keras.layers import Dense, Dropout, LSTM, Bidirectional, Input, Flatten , Activation , RepeatVector , Permute,Lambda, BatchNormalization, TimeDistributed
...
def worker(params,runParmsDic,return_dict):
    ...
    X_train = X_train.reshape((n_samples_train, params['seq'], (int)(n_timesteps / params['seq']), n_features))
    X_test = X_test.reshape((n_samples_test, params['seq'], (int)(n_timesteps / params['seq']), n_features))
